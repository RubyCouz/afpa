...
// Navbar
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > 50) {
            $('nav').css('background', '#8f1021');
            $('.summary').css('background', '#e2e8df');
            $('.summary .tab a').css('color', '#8f1021');
            $('.summary .indicator').css('background', '#8f1021');
        } else {
            $('nav').css('background', 'rgba(0,0,0,0.2)');
            $('.summary').css('background', 'rgba(0,0,0,0.2)');
            $('.summary .tab a').css('color', '#e2e8df');
            $('.summary .indicator').css('background', '#e2e8df');
        }
    });
    // collapsible
