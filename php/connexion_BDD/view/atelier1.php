...
<div class="uk-container">
    ...
    <ul uk-accordion="multiple: true">
        ...
        <li>
            <a class="uk-accordion-title" href="#">Présentation</a>
            <div class="uk-accordion-content">
                <p>
...
'
    ...
    ') ?>
        ...
        <li>
            <a class="uk-accordion-title" href="#">Le header</a>
            <div class="uk-accordion-content">
                <p>
    ...
    ') ?>
        ...
        <li>
            <a class="uk-accordion-title" href="#">Le footer</a>
            <div class="uk-accordion-content">
...
') ?>
        ...
        <li>
            <a class="uk-accordion-title" href="#">Réunion des fichiers "header.php" et "footer.php" dans le fichier "index.php"</a>
            <div class="uk-accordion-content">
                <p>
